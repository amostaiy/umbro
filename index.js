...
client.on("message", async message => {
  ...
  if (message.content.match(prefixMention)) {
    ...
    let embed = new MessageEmbed()
        ...
        :question: Still need help? [Click Here](https://discord.gg/7w7KSZcBkG) to join server
        `)
...
cooldown.delete(message.author.id)}, cdseconds * 1000)
  ...
  if (command.premium) {
    ...
    if (!guild) {
      return message.channel.send(`You can use this command in only premium server. \n **Want to make your server premium?** Donate US! Using invite your friends to this server 10 invites :) : https://discord.gg/uUg7fvFYxX `)
    }
